...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{ asset('vendors_template/feather/feather.css')}}">
  <link rel="stylesheet" href="{{ asset('vendors_template/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{ asset('vendors_template/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{ asset('vendors_template/typicons/typicons.css')}}">
  <link rel="stylesheet" href="{{ asset('vendors_template/simple-line-icons/css/simple-line-icons.css')}}">
  <link rel="stylesheet" href="{{ asset('vendors_template/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{ asset('vendors_template/datatables.net-bs4/dataTables.bootstrap4.css')}}">
...
<body>
  ...
  <!-- plugins:js -->
  <script src="{{ asset('vendors_template/js/vendor.bundle.base.js')}}"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="{{ asset('vendors_template/chart.js/Chart.min.js')}}"></script>
  <script src="{{ asset('vendors_template/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{ asset('vendors_template/progressbar.js/progressbar.min.js')}}"></script>
